package com.ithena.krishna.ithenaMusic.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (SplashActivity.tf4 != null) {
            ...
            fragTitle.setTypeface(com.ithena.krishna.ithenaMusic.activities.SplashActivity.tf4);
        }
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.ithena.krishna.ithenaMusic.utilities.CommonUtils.dpTopx(65, getContext());
        }
        ...
        githubLinkBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://github.com/krishna4741");
